  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-white border border-gray-200 rounded-lg p-5">
        <h2 className="font-semibold mb-3">Score a Niche On Demand</h2>
      ...
      <div className="flex gap-2">
        {niche.gate1_state === 'awaiting_review' && (
          <>
            ...
            <form action={dismissNiche.bind(null, niche.id)}>
              <button className="bg-gray-200 text-gray-700 text-xs px-3 py-1.5 rounded hover:bg-gray-300">
                Dismiss
              </button>
            </form>
          </>
        ...
        {niche.status === 'testing' && (
          <form action={archiveNiche.bind(null, niche.id)}>
            <button className="text-red-500 text-xs px-3 py-1.5 rounded hover:bg-red-50">
              Archive
            </button>
          </form>
        )}
